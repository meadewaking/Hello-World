						...
						<div class="main">
							...
							<div class="row">
								...
								<div class="col-md-8">
									...
									<form class="form-horizontal" id="frmSendNote"
										action="SendNoteServlet" method="post">
										<!-- tile -->
																...
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		<select
																			...
																			id="selSenderId" name="selSenderId">
																			<option value="">-请选择-</option>
																			<c:forEach items="${senders}" var="sender">
																				<option value="${sender.loginId}">${sender.loginName}</option>
																			</c:forEach>
																		</select>
																	</div>
																</div>
