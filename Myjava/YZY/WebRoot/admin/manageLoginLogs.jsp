...
<body class="bg-1">
		...
		<div class="row">
			...
			<div id="content" class="col-md-12">
						...
						<div class="tile-body">
							...
							<div class="form-horizontal" role="form">
								...
								<div class="form-group">
									<label for="input01" class="col-sm-4 control-label">登录时间</label>
									<div class="col-sm-4">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="txtSearchLoginIp"
											name="txtSearchLoginIp" placeholder="登录IP"
											value="${searcher.loginIp }">
									</div>
								</div>
				...
				<section class="tile color transparent-black">
					...
					<div class="tile-header">
						<h1>
							<strong>登录日志信息列表</strong>
						</h1>

						<div class="controls">
							<a href="/YZY/file/loginLogs.csv">导出数据</a> <a
								href="#" class="remove"><i class="fa fa-times"></i></a>
						</div>
					</div>
					<!-- /tile header -->
							...
							<thead>
								<tr>
									...
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('LoginLogId');">登录日志编号</a></th>
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('LoginDateTime');">登录时间</a></th>
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('LoginIp');">登录IP</a></th>
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('LoginId');">登录名</a></th>
	...
	<script type="text/javascript">
		...
		$("#btnSearch").click(
				function() {
					var flag = true;
					if ($("#txtSearchLoginDateTime").val().length == 0
							&& $("#txtSearchLoginIp").val().length == 0
							&& $("#txtSearchLoginId").val().length == 0) {
						$("#spanSearchLoginDateTime").text("查询条件不能为空！");
						flag = false;
					} else
						$("#spanSearchLoginDateTime").text("");
		...
		function removeLoginLog(loginLogId, loginDateTime) {
			if (confirm("是否删除？" + loginDateTime + "登录日志信息？")) {
