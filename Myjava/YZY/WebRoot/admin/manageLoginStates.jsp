...
<body class="bg-1">
		...
		<div class="row">
			...
			<div id="content" class="col-md-12">
				...
				<form class="form-horizontal" id="frmLoginStates"
					...
					<section class="tile color transparent-black">
						...
						<div class="tile-header">
							...
							<c:if test="${empty requestScope.ModifyLoginState}">
								<h1>
									<strong>登录状态信息添加</strong>
								</h1>
							</c:if>
							<c:if test="${not empty requestScope.ModifyLoginState}">
								<h1>
									<strong>登录状态信息修改</strong>
								</h1>
							</c:if>
							<div class="controls">
						...
						<div class="tile-body">
							...
							<div class="form-horizontal" role="form">
								...
								<div class="form-group">
									<label for="input01" class="col-sm-4 control-label">登录状态名称</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" id="txtLoginStateName"
											name="txtLoginStateName" placeholder="登录状态名称"
								...
								<div class="form-group">
									<label for="input02" class="col-sm-4 control-label">可登录</label>
									<div class="col-sm-8">
										<label class="checkbox-inline"> <input type="checkbox"
											name="txtCanLogin" placeholder="可登录" value="true"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="txtDescription"
											placeholder="描述"
											value="${requestScope.ModifyLoginState.description }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control"
											id="txtSearchLoginStateName" name="txtSearchLoginStateName"
											placeholder="登录状态名称" value="${searcher.loginStateName }">
										<span class="label label-danger" id="spanSearchLoginStateName"></span>
									</div>
								</div>
				...
				<section class="tile color transparent-black">
					...
					<div class="tile-header">
						<h1>
							<strong>登录状态信息列表</strong>
						</h1>

						<div class="controls">
							<a href="/YZY/file/loginStates.csv">导出数据</a> <a
								href="#" class="remove"><i class="fa fa-times"></i></a>
						</div>
					</div>
					<!-- /tile header -->
							...
							<thead>
								<tr>
									...
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('LoginStateId');">登录状态编号</a></th>
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('LoginStateName');">登录状态名称</a></th>
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('CanLogin');">登录状态</a></th>
									<th class="sortable sort-alpha"><a
								...
								<c:forEach items="${loginStates}" var="loginState"
									...
									<tr>
										...
										<td><c:if test="${loginState.canLogin}">
												...
												<i class="check-toggler checked"></i>
	...
	<script type="text/javascript">
		/*	$("#frmLoginStates").submit(function() {
				var flag = true;
				if ($("#txtLoginStateName").val().length == 0) {
					$("#spanLoginStateName").text("登录状态名称不能为空!");
					flag = false;
				} else
		...
		$("#btnSearch").click(
				function() {
					...
					if ($("#txtSearchLoginStateName").val().length == 0
							&& $("#txtSearchCanLogin").val().length == 0
		...
		function removeLoginState(loginStateId, loginStateName) {
			if (confirm("是否删除？" + loginStateName + "登录状态信息？")) {
