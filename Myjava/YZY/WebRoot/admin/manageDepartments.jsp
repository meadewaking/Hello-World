						...
						<div class="tile-body">
							...
							<div class="form-horizontal" role="form">
								...
								<div class="form-group">
									<label for="input01" class="col-sm-4 control-label">部门名称</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" id="txtDepartmentName"
											name="txtDepartmentName" placeholder="部门名称"
											value="${requestScope.ModifyDepartment.departmentName }">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="txtAddress"
											placeholder="所在地址"
											value="${requestScope.ModifyDepartment.address }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="txtDescription"
											placeholder="描述"
											value="${requestScope.ModifyDepartment.description }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control"
											...
											placeholder="部门名称" value="${searcher.departmentName }">
										<span class="label label-danger" id="spanSearchDepartmentName"></span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="txtSearchAddress"
											name="txtSearchAddress" placeholder="所在地址"
											value="${searcher.address }">
									</div>
								</div>
							...
							<thead>
								<tr>
									...
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('DepartmentId');">部门编号</a></th>
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('DepartmentName');">部门名称</a></th>
									<th class="sortable sort-alpha"><a
										href="javascript:sorting('Address');">部门地址</a></th>
									<th class="sortable sort-alpha"><a
